...
- **Project Code**: `SFMCP`
- **Project Name**: SureFinance MCP Server
- **Letta Agent ID**: `agent-ab7ad09a-b988-4184-94cc-7e99a3732d62`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `SFMCP`
2. **Issue references**: All issues for this project use the format `SFMCP-XXX` (e.g., `SFMCP-123`)
...
**Project PM Agent:** `Huly - SureFinance MCP Server` (agent-ab7ad09a-b988-4184-94cc-7e99a3732d62)
...
```json
{
  ...
  "agent": "Huly - SureFinance MCP Server",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/surefinance-mcp-server"
}
```
